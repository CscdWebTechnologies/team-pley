...
const Crypto = () => {
  return (
    <div className="container crypto-main">
      <div className="d-flex justify-content-around">
        <h1 className="crypto__h1">The most trusted cryptocurrency platform</h1>
      </div>
      <div className="d-flex justify-content-around">
        <p className="crypto_p">
