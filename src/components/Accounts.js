    ...
    <div className="accounts__main">
      <div className="accounts__wrapper">
        <div className="accounts__header">
          <h1 className="accounts__h1">Get started in a few minutes</h1>
          <p className="accounts__p">
            Coinbase supports a variety of the most popular digital currencies.
          </p>
        </div>

        <section className="accounts__boxes">
          <div className="account">
            ...
            <h2 className="account_h2">Create An Account</h2>
          </div>

          {/* lines */}
          <div className="hr_lines"></div>
          ...
          <div className="account">
            ...
            <h2 className="account_h2">Link Your Bank Account</h2>
          </div>
          ...
          <div className="account">
            ...
            <h2 className="account_h2">Start buying & selling</h2>
          </div>
        </section>
      </div>
    </div>
